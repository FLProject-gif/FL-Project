...
function Speakers() {
  ...
  const people = [["M Fajrin Rasyid", "Co-Founder Bukalapak", "speaker-fajrin.png", "brand-bukalapak.png"], ["Kilala Tilaar", "CEO Martha Tilaar Group", "speaker-kilala.png", "brand-martha-tilaar.png"], ["Ben Wirawan", "Founder Torch.id", "speaker-ben.png", "brand-torch.png"], ["Dian Aryanti", "CEO Ciomy", "speaker-dwi.png", "brand-ciomy.png"], ["M. Hadiyatuloh", "Founder Brighty", "speaker-hadiyatuloh.jpg", "brand-brighty.png"], ["Dhony Pratama", "Founder Susu Mbok Darmi", "speaker-dhony.png", "brand-mbok-darmi.png"], ["Adythia Pratama", "Content Creator & Founder f15library.com", "speaker-adyhtia.png", ""], ["Taufiq Yusuf", "Survival Architecture Indonesia", "speaker-yusuf.jpg", ""], ["Suhu Wan", "Founder Idolmart", "speaker-suhu-wan.png", ""], ["M Rizky Ramadhan", "Founder Roscik", "speaker-rizky.png", ""], ["Azfar Reza", "Founder Jilbrave", "speaker-azfar.png", "brand-jilbrave.png"], ["Leo Giovanni", "Content Creator & Founder Clippo.id", "speaker-leo.png", "brand-clippo.png"], ["Samuel Christ", "Content Creator & Founder Seefluencer", "speaker-samuel.png", "brand-seefluencer.png"], ["Aviwkila", "Bintang Tamu · Penyanyi", "speaker-aviwkila.png", ""], ["Suryana Paramita", "Produser Film Sore", "speaker-surya.png", "brand-film-sore.png"], ["Dr. H. Tri Adhianto", "Walikota Bekasi", "speaker-tri-adhianto.png", ""], ["Ratanca Setiawan", "Juara 3 SUCI 12 Kompas TV", "speaker-ratanca.png", ""], ["Syammas P. Syarbini", "Canva Verified Expert", "speaker-syammas.png", ""]];
  return /*#__PURE__*/React.createElement("section", {
    id: "speaker",
    style: {
