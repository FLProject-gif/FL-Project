      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 1280, margin: "0 auto", padding: isMobile ? "40px var(--gutter) 48px" : "56px var(--gutter) 72px", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.05fr .95fr", gap: isMobile ? 32 : 40, alignItems: "center" }}>
        ...
        <div style={{ display: isMobile ? "none" : "flex", justifyContent: "center" }}>
          <div style={{ background: "var(--pwb-blue-royal)", borderRadius: "var(--radius-2xl)", padding: "22px 20px 24px", boxShadow: "0 30px 70px rgba(0,40,120,.4)", textAlign: "center", maxWidth: 380, width: "100%" }}>
            <img src="assets/logo-badges-strip-blue.png" alt="TDA Bekasi · To The Next Level · 2 Dekade" style={{ width: "100%", maxWidth: 280, height: "auto", margin: "0 auto 14px", display: "block" }} />
